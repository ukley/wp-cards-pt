<?php
/**
 * Breezycv Theme Editor Styles
 *
 */

function breezycv_theme_settings_css() {
	...
	$editor_css = '
		...
		.post-type-page .editor-styles-wrapper .editor-post-title__block > div {
			position: relative;
		}
	...
	return apply_filters( 'breezycv_theme_settings_css', $editor_css );
}
