 ...
 * @return string
 */
function breezycv_theme_font_url() {
	$font_url = '';
	/*
	 * Translators: If there are characters in your language that are not supported
	 * by Lato, translate this to 'off'. Do not translate into your own language.
	 */
	if ( 'off' !== _x( 'on', 'Lato font: on or off', 'breezycv' ) ) {
 ...
 */
function breezycv_theme_has_featured_posts() {
 ...
 */ {
	function breezycv_theme_the_attached_image() {
		$post = get_post();
		/**
 ...
 */ {
	function breezycv_theme_list_authors() {
					...
					<div class="contributor-summary">
						...
						<a class="button contributor-posts-link"
						   href="<?php echo esc_url( get_author_posts_url( $contributor_id ) ); ?>">
							<?php printf( _n( '%d Article', '%d Articles', $post_count, 'breezycv' ), $post_count ); ?>
						</a>
					</div>
					<!-- .contributor-summary -->
				</div>
 ...
 */
{
	 ...
	 */ {
		function breezycv_theme_paging_nav( $wp_query = null ) {
			...
			$links = paginate_links( array(
				...
				'prev_text' => esc_html__( 'Previous', 'breezycv' ),
				'next_text' => esc_html__( 'Next', 'breezycv' ),
			) );
	...
	if ( ! function_exists( 'breezycv_theme_post_nav' ) ) : /**
	 * Display navigation to next/previous post when applicable.
	 */ {
		function breezycv_theme_post_nav() {
			...
			<nav class="navigation post-navigation clearfix">
				<div class="nav-links">
					<?php
					if ( is_attachment() ) :
						previous_post_link( '%link', ('<span class="meta-nav">' . esc_html__( 'Published In', 'breezycv' ) . ' %title' . '</span>') );
					else :
	 ...
	 * Display navigation to next/previous post when applicable.
	 */ {
		function breezycv_theme_portfolio_nav() {
			// Don't print empty markup if there's nowhere to navigate.
			...
			<nav class="portfolio-page-nav">
				<div class="nav-item portfolio-page-prev-next">
					...
					?>
						...
						<?php endif; ?>
							    <span class="meta-nav" title="<?php echo esc_attr($prev_title); ?>"><i class="lnr lnr-chevron-left portfolio-nav-prev"></i></span>
							</a>
					<?php
					endif;
					?>
					...
					?>
						...
						<?php endif; ?>
						    <span class="meta-nav" title="<?php echo esc_attr($next_title); ?>"><i class="lnr lnr-chevron-right portfolio-nav-next"></i></span>
						</a>
					<?php
					endif;
					?>
	...
	if ( ! function_exists( 'breezycv_theme_posted_on' ) ) : /**
	 * Print HTML with meta information for the current post-date/time and author.
	 */ {
		function breezycv_theme_posted_on() {
	...
	if ( ! function_exists( 'breezycv_theme_post_category' ) ) : /**
	 * Print HTML with meta information for the current post-date/time and author.
	 */ {
		function breezycv_theme_post_category() {
			if ( is_sticky() && is_home() && ! is_paged() ) {
				echo '<span class="featured-post"><i class="fa fa-fw fa-thumb-tack"></i> ' . esc_html__( 'Featured', 'breezycv' ) . ' </span>';
			}
	 ...
	 */
	function breezycv_theme_categorized_blog() {
	 ...
	 */
	function breezycv_theme_post_thumbnail() {
