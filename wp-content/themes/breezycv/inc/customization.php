...
function breezycv_theme_customizations() {
    //================================================================================================================================
    // Custom styles
    //================================================================================================================================
    ...
    $content_max_width = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('content_max_width') : '1280';
    ...
    $content_bg_color = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('content_bg_color') :  '#fff';


    //================================================================================================================================
    // Main color
    //================================================================================================================================
    $theme_main_color = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('main_color') : '#0ba376';
    ...
    $body_bg_gradient_from = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('body_gradient_from') : '#edf3f7';
    $body_bg_gradient_to = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('body_gradient_to') : '#edf3f7';
    ...
    $body_text_color = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('body_text_color') : '#555';
    ...
    $headings_color = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('headings_color') : '#222';
    ...
    //================================================================================================================================
    $cp_general_bg_color = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('cp_title_general_bg_color') : '#0ba376';

    $cp_general_bg_gradient_from = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('pc_gradient_from') : '#0b7080';
    $cp_general_bg_gradient_to = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('pc_gradient_to') : '#0ba376';

    $cp_general_title_size = ( function_exists('fw_get_db_settings_option') ) ? fw_get_db_settings_option('cp_title_general_title_font/size') : '32';
    ...
    return apply_filters( 'breezycv_theme_customizations', $customization_css ); 
